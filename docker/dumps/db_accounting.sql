...
\restrict LItMh51TYqgfd9m874b01l92dFcSjRna4LksRyhW1HAgB8AFLuDDjSwng7ujsrf
...
CREATE TABLE public.ledger_entries (
    ...
    CONSTRAINT ledger_entries_entry_type_check CHECK (((entry_type)::text = ANY ((ARRAY['revenue'::character varying, 'expense'::character varying])::text[])))
);
...
COPY public.ledger_entries (id, tenant_id, entry_type, amount, description, reference_type, reference_id, created_at, updated_at) FROM stdin;
1	592c7d15-8525-43f1-9db3-2eb43ea43d4b	revenue	15.50	Platform Commission for Order #ORD-123	Order	ORD-123	2025-12-29 07:18:59	2025-12-29 07:18:59
2	592c7d15-8525-43f1-9db3-2eb43ea43d4b	expense	10.00	Payout to Agent Rahul	Payout	PAY-001	2025-12-29 07:19:15	2025-12-29 07:19:15
\.
...
4	2025_01_01_000000_create_ledger_entries_table	1
5	2025_12_29_071720_create_personal_access_tokens_table	1
\.
...
SELECT pg_catalog.setval('public.ledger_entries_id_seq', 2, true);
...
\unrestrict LItMh51TYqgfd9m874b01l92dFcSjRna4LksRyhW1HAgB8AFLuDDjSwng7ujsrf
