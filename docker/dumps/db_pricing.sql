...
\restrict oOC5cdcsS8VujcG95FgK0fA8Q3uYITn0oQqoyUehMNyXD7zXdrtougCwla5tMmf
...
ALTER TABLE IF EXISTS ONLY public.pricing_rules DROP CONSTRAINT IF EXISTS pricing_rules_tenant_id_unique;
...
CREATE TABLE public.pricing_rules (
    ...
    per_km_rate numeric(10,2) DEFAULT '0'::numeric NOT NULL,
    per_kg_rate numeric(10,2) DEFAULT '0'::numeric NOT NULL,
...
4	2025_01_01_000000_create_pricing_rules_table	1
5	2025_12_29_054416_create_personal_access_tokens_table	1
\.
...
COPY public.pricing_rules (id, tenant_id, base_fare, per_km_rate, per_kg_rate, is_active, created_at, updated_at) FROM stdin;
f6d9c1de-70d4-49aa-b87c-e60847ec55f3	592c7d15-8525-43f1-9db3-2eb43ea43d4b	50.00	10.00	5.00	t	2025-12-29 05:46:17	2025-12-29 05:46:17
\.
...
--
-- Name: pricing_rules pricing_rules_tenant_id_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pricing_rules
    ADD CONSTRAINT pricing_rules_tenant_id_unique UNIQUE (tenant_id);
...
\unrestrict oOC5cdcsS8VujcG95FgK0fA8Q3uYITn0oQqoyUehMNyXD7zXdrtougCwla5tMmf
